...
const PerScreen = ({navigation, step, ques, onNext}) => {
  ...
  return (
      ...
      <View style={styles.container}>
        ...
        <View style={styles.listCuisinesContainer}>
          {listCuisines}
        </View>

        <TouchableOpacity onPress={handleOnNext}>
          <View style={[styles.btn, checkNextStatus() ? styles.btnSkip : styles.btnNext]}>
    
            <Text style={[styles.btnText, {color: checkNextStatus() ? "#4CAF50" : "#ffffff"}]}>
