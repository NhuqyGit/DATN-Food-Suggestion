...
const ListRecordScreen = () => {
  ...
  const handleFetchListRecord = async () => {
    ...
    try {
      const response = await fetch(`${HOST}/users/${userId}/records`, {
        headers,
      })
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          ...
          style={[
            ...
            {
              backgroundColor:
                isSelect !== recordId ? theme.colors.secondary : '#ebebeb',
            },
          ]}
        >
          <Text
            style={[
              styles.btnText,
              {
                color: isSelect !== recordId ? 'white' : theme.colors.darkGray,
              },
            ]}
          >
            Select
